...
to enable/disable gzip compression of the dlocatedb file.  This option
is obsolete and unsupported unless someone wants to provide a patch
(shouldn't be too hard with, say, B<IO::Compress::Gzip>)
